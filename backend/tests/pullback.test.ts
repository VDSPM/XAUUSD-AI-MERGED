...
import type { DirectionAlignment, TimeframeStructure } from "../src/structure/types.js";

function makeStructure(bias: "bullish" | "bearish"): TimeframeStructure {
  return {
    timeframe: "4H",
    bias,
    swingPoints:
...
function makeAlignment(bias: "bullish" | "bearish"): DirectionAlignment {
